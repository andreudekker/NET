...
namespace ADO_datagrid_BD_ {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(string Nombre, string Apellido, string Ciudad, string Pais) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow FindByClienteID(int ClienteID) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public int ClienteID {
                get {
                    return ((int)(this[this.tableTable.ClienteIDColumn]));
                }
                set {
                    this[this.tableTable.ClienteIDColumn] = value;
                }
            }
            ...
            public string Ciudad {
                get {
                    try {
                        return ((string)(this[this.tableTable.CiudadColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Ciudad\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.CiudadColumn] = value;
                }
            }
            ...
            public string Pais {
                get {
                    try {
                        return ((string)(this[this.tableTable.PaisColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Pais\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.PaisColumn] = value;
                }
            }
            ...
            public bool IsCiudadNull() {
                return this.IsNull(this.tableTable.CiudadColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetCiudadNull() {
                this[this.tableTable.CiudadColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public bool IsPaisNull() {
                return this.IsNull(this.tableTable.PaisColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetPaisNull() {
                this[this.tableTable.PaisColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace ADO_datagrid_BD_.Database1DataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([ClienteID] = @Original_ClienteID) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Apellido = 1 AND [Apellido] IS NULL) OR ([Apellido] = @Original_Apellido)) AND ((@IsNull_Ciudad = 1 AND [Ciudad] IS NULL) OR ([Ciudad] = @Original_Ciudad)) AND ((@IsNull_Pais = 1 AND [Pais] IS NULL) OR ([Pais] = @Original_Pais)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Nombre], [Apellido], [Ciudad], [Pais]) VALUES (@Nombr" +
                "e, @Apellido, @Ciudad, @Pais);\r\nSELECT ClienteID, Nombre, Apellido, Ciudad, Pais" +
                " FROM [Table] WHERE (ClienteID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Nombre] = @Nombre, [Apellido] = @Apellido, [Ciudad] = @Ciudad, [Pais] = @Pais WHERE (([ClienteID] = @Original_ClienteID) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Apellido = 1 AND [Apellido] IS NULL) OR ([Apellido] = @Original_Apellido)) AND ((@IsNull_Ciudad = 1 AND [Ciudad] IS NULL) OR ([Ciudad] = @Original_Ciudad)) AND ((@IsNull_Pais = 1 AND [Pais] IS NULL) OR ([Pais] = @Original_Pais)));
SELECT ClienteID, Nombre, Apellido, Ciudad, Pais FROM [Table] WHERE (ClienteID = @ClienteID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ADO_datagrid_BD_.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ClienteID, Nombre, Apellido, Ciudad, Pais FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_ClienteID, string Original_Nombre, string Original_Apellido, string Original_Ciudad, string Original_Pais) {
        ...
        public virtual int Insert(string Nombre, string Apellido, string Ciudad, string Pais) {
            if ((Nombre == null)) {
        ...
        public virtual int Update(string Nombre, string Apellido, string Ciudad, string Pais, int Original_ClienteID, string Original_Nombre, string Original_Apellido, string Original_Ciudad, string Original_Pais, int ClienteID) {
            if ((Nombre == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Apellido, string Ciudad, string Pais, int Original_ClienteID, string Original_Nombre, string Original_Apellido, string Original_Ciudad, string Original_Pais) {
            return this.Update(Nombre, Apellido, Ciudad, Pais, Original_ClienteID, Original_Nombre, Original_Apellido, Original_Ciudad, Original_Pais, Original_ClienteID);
        }
    }
