...
namespace StronglyType_Ado2._0 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ClientesRow AddClientesRow(string Nombre, string Apellido, string Pais) {
...
namespace StronglyType_Ado2._0.Database1DataSetTableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Clientes] WHERE (([Nombre] = @Original_Nombre) AND ((@IsNull_A" +
                "pellido = 1 AND [Apellido] IS NULL) OR ([Apellido] = @Original_Apellido)) AND ((" +
                "@IsNull_Pais = 1 AND [Pais] IS NULL) OR ([Pais] = @Original_Pais)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Clientes] ([Nombre], [Apellido], [Pais]) VALUES (@Nombre, @Ape" +
                "llido, @Pais);\r\nSELECT Nombre, Apellido, Pais FROM Clientes WHERE (Nombre = @Nom" +
                "bre)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Clientes] SET [Nombre] = @Nombre, [Apellido] = @Apellido, [Pais] = @Pais WHERE (([Nombre] = @Original_Nombre) AND ((@IsNull_Apellido = 1 AND [Apellido] IS NULL) OR ([Apellido] = @Original_Apellido)) AND ((@IsNull_Pais = 1 AND [Pais] IS NULL) OR ([Pais] = @Original_Pais)));
SELECT Nombre, Apellido, Pais FROM Clientes WHERE (Nombre = @Nombre)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::StronglyType_Ado2._0.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Nombre, Apellido, Pais FROM dbo.Clientes";
        ...
        public virtual int Delete(string Original_Nombre, string Original_Apellido, string Original_Pais) {
        ...
        public virtual int Update(string Nombre, string Apellido, string Pais, string Original_Nombre, string Original_Apellido, string Original_Pais) {
            if ((Nombre == null)) {
                throw new global::System.ArgumentNullException("Nombre");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Apellido, string Pais, string Original_Nombre, string Original_Apellido, string Original_Pais) {
            return this.Update(Original_Nombre, Apellido, Pais, Original_Nombre, Original_Apellido, Original_Pais);
        }
    }
